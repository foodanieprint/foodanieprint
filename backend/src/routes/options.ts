...
optionsRouter.get('/', async (req: AuthenticatedRequest, res: Response) => {
  try {
...
optionsRouter.post('/', async (req: AuthenticatedRequest, res: Response) => {
  try {
...
optionsRouter.put('/', async (req: AuthenticatedRequest, res: Response) => {
  try {
...
optionsRouter.delete('/', async (req: AuthenticatedRequest, res: Response) => {
  try {
